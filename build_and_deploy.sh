...
cd ../telematics
docker build -t miksamixa/foober-telematics:v1 .
docker push miksamixa/foober-telematics:v1

cd ../vehicles
docker build -t miksamixa/foober-vehicles:v2 .
docker push miksamixa/foober-vehicles:v2

cd ../rides
docker build -t miksamixa/foober-rides:v2 .
docker push miksamixa/foober-rides:v2

# create a K8S cluster on GKE
cd ..
gcloud container clusters create foober --num-nodes 8 --machine-type n1-standard-1
